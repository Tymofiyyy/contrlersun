    ...
    if (confirm == true && mounted) {
      ...
      if (mounted) {
        if (success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Помилка видалення розкладу'),
              backgroundColor: Colors.red,
            ),
          );
        }
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.bold,
                          color:
                              schedule.isEnabled ? Colors.black : Colors.grey,
                        ),
                      ),
                      const SizedBox(height: 4),
                      Row(
                ...
                Switch(
                  ...
                  activeColor: isSolar ? Colors.orange : Colors.blue,
                ),
              ],
            ),
            ...
            // Наступне виконання
            if (schedule.nextExecution != null && schedule.isEnabled)
              Padding(
